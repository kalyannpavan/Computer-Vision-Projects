...
def main():
    ...
    for t in time_range:  # Generate a sequence of images as a function of time
        ...
        blue_T = T1 + velocity * t + 0.5 * acc * t * t
        ...
        v = Map2Da(K, R, blue_T, V1)
        blue_v1 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V2)
        blue_v2 = MapIndex(v, c0, r0, p)
        
        v = Map2Da(K, R, blue_T, V3)
        blue_v3 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V4)
        blue_v4 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V5)
        blue_v5 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V6)
        blue_v6 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V7)
        blue_v7 = MapIndex(v, c0, r0, p)

        v = Map2Da(K, R, blue_T, V8)
        blue_v8 = MapIndex(v, c0, r0, p)
        ...
        A = cv2.resize(Background_image,(600,600))
        ...
        A = drawLine(A, blue_v1, blue_v2, color1, thickness)
        A = drawLine(A, blue_v2, blue_v3, color1, thickness)
        A = drawLine(A, blue_v3, blue_v4, color1, thickness)
        A = drawLine(A, blue_v4, blue_v1, color1, thickness)
        A = drawLine(A, blue_v5, blue_v7, color1, thickness)
        A = drawLine(A, blue_v6, blue_v8, color1, thickness)
        A = drawLine(A, blue_v7, blue_v6, color1, thickness)
        A = drawLine(A, blue_v8, blue_v5, color1, thickness)
        A = drawLine(A, blue_v1, blue_v7, color1, thickness)
        A = drawLine(A, blue_v2, blue_v6, color1, thickness)
        A = drawLine(A, blue_v3, blue_v8, color1, thickness)
        A = drawLine(A, blue_v4, blue_v5, color1, thickness)
        ...
        for i in range(r):
            for j in range(c):
                ...
                #note: cast ir, jr to int so it can index array 
                #(ir, jr) = ?????????????????????????
